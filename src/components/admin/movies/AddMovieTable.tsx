    ...
    if (accessToken == null) {
      const swalText = `<div style='color:whitesmoke'>You don't have permissions to perform this action!</div>`;
        ...
        await interceptionAxios.post(`api/v1/cinema/movies`, addedMovie, config).then((res: any) => {
          const swalText = `<div style='color:whitesmoke'>You have successfully created movie: <b>${addedMovie.title}</b>!</div>`;
          Swal.fire({
      ...
      <div>
          <div className="add-equipment-container" style={{ marginTop: '5%' }}>
              <div className="add-equipment-form">
                  <p className="signup-title">Add new movie</p>
                  <p className="signup-text">Enter movie's information</p>
                  <TextField
                    ...
                    />
                  <Button className="equipment-button" variant="contained" onClick={addMovie}>
                      Add
                  </Button>
              </div>
